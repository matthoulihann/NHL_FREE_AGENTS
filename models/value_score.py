...
if 'Predicted AAV' in df.columns and 'Final_Predicted_GAR_25_26' in df.columns:
    ...
    # Calculate League Cost Per GAR (Filtering out low-GAR players to remove noise)
    ...
    # Adjust FMV (No position multiplier)
    df['Fair_Market_Value'] = df['Final_Predicted_GAR_25_26'] * league_cost_per_gar

    # Ensure Fair Market Value (FMV) and AAV are not lower than 775k
    ...
    # Clip scores to ensure they are within 0-100 range and convert to integer
